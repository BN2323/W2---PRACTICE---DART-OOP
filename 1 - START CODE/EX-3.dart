...
class MyDuration {
  ...
  bool operator >(MyDuration other) {
    return this._milliseconds > other.milliseconds;
  }

  String operator +(MyDuration other) {
    return MyDuration(_milliseconds + other.milliseconds).toString();
  }

  String operator -(MyDuration other) {
    if (_milliseconds < other.milliseconds) {
